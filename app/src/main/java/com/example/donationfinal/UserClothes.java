...
public class UserClothes extends AppCompatActivity {
    ...
    private String user_clothes_url = "https://daan2020.000webhostapp.com/jsondetail.php";
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(UserClothes.this);
    ...
    private void loadDashboard() {
        ...
        private void userCloth() {
            ...
            try {
                ...
                request.put(KEY_CATEGORY,"Cloth");

            } catch (JSONException e) {
                e.printStackTrace();
            }
            JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                    (Request.Method.POST, user_clothes_url, request, new Response.Listener<JSONObject>() {
                        @Override
    ...
    private boolean validateInputs() {
        ...
        if (KEY_EMPTY.equals(name)) {
            etname.setError(" Foodname cannot be empty");
            etname.requestFocus();
            return false;
