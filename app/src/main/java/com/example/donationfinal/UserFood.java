...
public class UserFood extends AppCompatActivity {
    ...
    private String user_food_url = "https://daan2020.000webhostapp.com/jsondetail.php";
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(UserFood.this);
    ...
    private void loadDashboard() {
        ...
        private void userFood() {
            ...
            JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                    (Request.Method.POST, user_food_url, request, new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                if (response.getInt(KEY_STATUS) == 0) {
                                    ...
                                    Toast.makeText(UserFood.this, response.getString(KEY_MESSAGE),Toast.LENGTH_LONG).show();
                                    loadDashboard();
